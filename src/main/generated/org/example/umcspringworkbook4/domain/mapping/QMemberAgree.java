...
public class QMemberAgree extends EntityPathBase<MemberAgree> {
    ...
    private static final long serialVersionUID = -412528442L;
    ...
    public final org.example.umcspringworkbook4.domain.QTerms terms;
    ...
    public QMemberAgree(Class<? extends MemberAgree> type, PathMetadata metadata, PathInits inits) {
        ...
        this.terms = inits.isInitialized("terms") ? new org.example.umcspringworkbook4.domain.QTerms(forProperty("terms")) : null;
    }
